...
Also, for obsidian I recommend getting the Latex Suite plugin. Very useful, makes latex go brrrrrrrr (esp for chem oh my its such a time saver)

Here is the custom snippet i use: (if you use the snippet you copy this into the snippet thing)\

**once you are done with this file (have learnt all the stuff), feel free to delete :)**
...
[
    ...
    {trigger: "sts", replacement: "\\text{$0}", options: "rmA"},
    ...
    {trigger: "([a-zA-Z])\\.,", replacement: "\\mathbf{[[0]]}", options: "rmA"},
    {trigger: "([A-Za-z])(\\d)", replacement: "[[0]]{[[1]]}", options: "rmA", description: "Auto letter subscript", priority: -1},
    {trigger: "\\\\mathbf{([A-Za-z])}(\\d)", replacement: "\\mathbf{[[0]]}{[[1]]}", options: "rmA"},
    ...
    // Visual operations
    {trigger: "U", replacement: "\\underbrace{ ${VISUAL} }{ $0 }", options: "mA"},
    ...
    // Symbols
    {trigger: "0slash", replacement: "\∅", options: "mA"},
    {trigger: "deg", replacement: "\\degree", options: "mA"},
    {trigger: "eqi", replacement: "\\rightleftharpoons", options: "mA"},
    {trigger: "ooo", replacement: "\\infty", options: "mA"},
    {trigger: "sum", replacement: "\\sum", options: "mA"},
    {trigger: "prod", replacement: "\\prod", options: "mA"},
    {trigger: "lim", replacement: "\\lim{ ${0:n} \\to ${1:\\infty} } $2", options: "mA"},
    ...
    {trigger: "xnn", replacement: "x{n}", options: "mA"},
    {trigger: "xii", replacement: "x{i}", options: "mA"},
    {trigger: "xjj", replacement: "x{j}", options: "mA"},
    {trigger: "xp1", replacement: "x{n+1}", options: "mA"},
    {trigger: "ynn", replacement: "y{n}", options: "mA"},
    {trigger: "yii", replacement: "y{i}", options: "mA"},
    {trigger: "yjj", replacement: "y{j}", options: "mA"},
    ...
    // Integrals
    {trigger: "oinf", replacement: "\\int{0}^{\\infty} $0 \\, d${1:x} $2", options: "mA"},
    {trigger: "infi", replacement: "\\int{-\\infty}^{\\infty} $0 \\, d${1:x} $2", options: "mA"},
    {trigger: "dint", replacement: "\\int{${0:0}}^{${1:\\infty}} $2 \\, d${3:x} $4", options: "mA"},
    ...
    // Physics
    {trigger: "kbt", replacement: "k{B}T", options: "mA"},
    ...
    {trigger: "msun", replacement: "M{\\odot}", options: "mA"},
    {trigger: "solm", replacement: "M{\\odot}", options: "mA"},
    {trigger: "ce", replacement: "\\ce{ $0 }", options: "mA"},
    {trigger: "iso", replacement: "{}^{${0:4}}{${1:2}}${2:He}", options: "mA"},
    {trigger: "hel4", replacement: "{}^{4}{2}He ", options: "mA"},
    {trigger: "hel3", replacement: "{}^{3}{2}He ", options: "mA"},
